...
function About() {
                            ...
                            <Row>
                                <Col className="align-items-center">
                                    ...
                                    <p>I'm a self-taught programmer with 3 years of development experience and I've
                                        ...
                                        projects (including this one). Additionally, I have experience designing APIs with Flask, Spring Boot, and .NET
                                        as well as relational tables with Postgres and SQL Server. Though I am confident in my
                                        coding abilities, I maintain that my most important skill is my adaptability. Juggling
                                        project management, software development, and data engineering is atypical for a programmer but it's
 ...
 {/*                                   <p>
                                    ...
                                    <p>
                                        ...
                                        don't hesitate to reach out. I'd love to connect and learn more about what you're building!
                                    </p>
                                </Col>
                            </Row>
                        </Card.Body>
